...
`;
  ...
  return (
    ...
    >
      ...
      {/* ── ActionCard (UI-PREMIUM-A.1: 겹침 방지 + 페이드인) ── */}
      <div style={{
        position: 'fixed',
        top: '50%',
        left: outreachVisible ? 'calc(50% - 230px)' : '50%',
        transform: 'translate(-50%, -50%)',
        width: outreachVisible ? 'min(440px, calc(100vw - 480px))' : 'min(520px, 92vw)',
        maxHeight: '82vh',
        overflowY: 'auto',
        overflowX: 'hidden',
        zIndex: 60,
        pointerEvents: actionContext ? 'auto' : 'none',
        opacity: outreachVisible ? 0 : 1,
        visibility: outreachVisible ? 'hidden' as const : 'visible' as const,
