  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: 'object',
        properties: {
          content_type: { type: 'string', enum: ['headcopy', 'storytelling', 'script', 'full_package'], description: 'headcopy=후킹/카피/문구, storytelling=스레드/인스타/공구글, script=릴스/영상/대본, full_package=공지문/종합' },
